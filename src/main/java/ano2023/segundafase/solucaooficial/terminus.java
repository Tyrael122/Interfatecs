...
class Harbor {
    ...
    public String printResult() {
        ...
        for (Ship ship : ships) {
            sb.append(ship.name).append(" ").append(String.format(Locale.ROOT, "%.2f", ship.cost()));
